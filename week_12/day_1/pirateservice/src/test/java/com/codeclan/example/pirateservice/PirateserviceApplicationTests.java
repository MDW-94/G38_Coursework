...
//
//		Raid raid = new Raid("Ram Raiding John Menzies");
//		raidRepository.save(raid);
//
////		This is done so that the ID for the Raid can be created
//
//		raid.addPirate(jack);
//		raidRepository.save(raid);
//
////		This is done so the Pirate and Raid can be linked
//	}
	...
	public void canFindShipsWithPiratesFirstName(){
		...
		assertEquals(10, foundShips.size());
	}
